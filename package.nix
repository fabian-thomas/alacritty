# https://github.com/NixOS/nixpkgs/blob/nixpkgs-unstable/pkgs/by-name/al/alacritty/package.nix
{
  stdenv,
  lib,
  fetchFromGitHub,
...
rustPlatform.buildRustPackage (finalAttrs: {
  pname = "alacritty";
  version = "0.16.1-patched";

  inherit src;

  cargoHash = "sha256-u6icCgVg+2quHbnE/K+OiJQfttmyfigVvYPUxHWdWQQ=";
